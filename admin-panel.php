...
<html lang="en">
  ...
  <a class="navbar-brand" href="#"><i class="fa fa-user-plus" aria-hidden="true"></i> TechTidy </a>
...
<style>
                ...
                <div class="col-sm-4" style="left: 20%;margin-top:5%">
                  <div class="panel panel-white no-radius text-center">
                    <div class="panel-body" >
                      ...
                      <h4 class="StepTitle" style="margin-top: 5%;">Scan you electronic device</h2>
                    
                      <p class="cl-effect-1">
                        <a class="cl-effect-1" href="scan.html">
                          Click here to scan
                        </a>
                      </p>
                    </div>
        ...
        <div class="container-fluid">
          <div class="card">
            <div class="card-body">
              ...
              <form class="form-group" method="post" action="admin-panel.php">
                <div class="row">
                  ...
                  ?> -->
                    ...
                    <div class="col-md-4">
                          <label for="spec">Select Device Type:</label>
                        </div>
                        <div class="col-md-8">
              ...
              <div class="col-md-4"><label for="doctor">Select Area</label></div>
                <div class="col-md-8">
  ...
  document.getElementById('doctor').onchange = function updateFees(e) {
    console.log("Selected Doctor:", this.value);
    var selectedOption = document.querySelector(`[value=${this.value}]`);
    console.log("Selected Option:", selectedOption);
    
    if (selectedOption) {
      var selection = selectedOption.getAttribute('data-value');
      console.log("Consultation Fees:", selection);
      
      document.getElementById('docFees').value = selection;
    } else {
      console.log("Doctor option not found.");
    }
  };
</script>
                  ...
                  <div class="col-md-4"><label for="consultancyfees">
                                Points to be gained on this disposal
                              </label></div>
                              <div class="col-md-8">
                  ...
                  <div class="col-md-4"><label>Scheduled Date</label></div>
                  <div class="col-md-8"><input type="date" class="form-control datepicker" name="appdate"></div><br><br>

                  <div class="col-md-4"><label>Scheduled Time</label></div>
                  <div class="col-md-8">
    ...
    <table class="table table-hover">
        ...
        <tbody>
            <?php 
                ...
                $query = "SELECT a.ID, d.spec, a.doctor, a.docFees, a.appdate, a.apptime, a.userStatus, a.doctorStatus 
                ...
                while ($row = mysqli_fetch_array($result)){
                    $sumPoints += $row['docFees']; // Increment sum
    ...
    <!-- Print sum of points -->
    <p>Total Points: <?php echo $sumPoints; ?></p>
