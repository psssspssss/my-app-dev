...
<html lang="en">
  ...
  <body style="background: -webkit-linear-gradient(left, #f5bf23, #00c6ff); background-size: cover;">
    <nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav" >
    <div class="container">

      <a class="navbar-brand js-scroll-trigger" href="index.php" style="margin-top: 10px;margin-left:-65px;font-family: 'IBM Plex Sans', sans-serif;"><h4>TechTidy</h4></a>
    ...
    animation: mover 1s infinite alternate;">
          <img src="https://cdn.pixabay.com/photo/2014/04/02/11/13/recycling-305569_1280.png" alt="" style="width: 20%;padding-left: 40px;margin-top: 150px;margin-left: 45px;margin-bottom:15px">
      </div>
